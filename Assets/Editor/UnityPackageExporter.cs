...
{
    public const string DefaultBuildIncludeRootPath = "Assets/UnityLocalStorage";
    public const string DefaultExportUnityPackageFilePath = "UnityLocalStorage.unitypackage";
